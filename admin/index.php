...
<body class="bg-gray-200">
    ...
    <div id="sideNav" class="lg:block hidden bg-white w-64 h-screen fixed rounded-none border-none">
        ...
        <div class="p-4 space-y-4">
            ...
            <a href="/admin/addarticles" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-500 group">
                <!-- <i class="fas fa-wallet"></i> -->
                <span>add article</span>
            </a>
            <a href="/admin/addmemes" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-500 group">
                <!-- <i class="fas fa-wallet"></i> -->
                <span>add memes</span>
            </a>
